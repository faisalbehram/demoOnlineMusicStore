...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            <label for="price2">Base Price</label>
            <input id="price" class="form-Control" name ="price" value="${product.price2.get(0).price}"/>
        </div>

		 <form:hidden path="price2" value="${product.price2.get(0).id}" />
